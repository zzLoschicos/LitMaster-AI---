        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {history.map((item) => (
            <div 
              ...
              className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 hover:shadow-md hover:border-indigo-300 cursor-pointer transition-all group"
            >
              ...
              <div className="flex items-center text-indigo-600 font-medium text-sm gap-1 group-hover:gap-2 transition-all">
                 查看详解 <ChevronRight className="w-4 h-4" />
              </div>
            </div>
          ))}
        </div>
